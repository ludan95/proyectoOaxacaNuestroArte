          ...
          <div class="col mb-5">
            <div class="card h-100">
              ...
              <div class="row">
                    ...
                    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-sm">
                        <div class="modal-content">
                          ...
                          <model-viewer bounds="tight" enable-pan src="../img/imgArtesanias/disenio_3d/taza_3d.glb" ar
                ...
                <div class="row-6" style="margin: 275px 0 0 10px;">
                  <div class="card-body p-4">
                    <div class="text-center">
                      <!-- Product name-->
                      <h5 class="subtitulo">Alebrije</h5>
                  ...
                  <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <p>
                      Alebrije con figura de Dragon pintado con colores especiales
                      alegres y vibrantes que forman un ser fantastico
                    </p>
                    <p>¡Diseño UNICO!</p>
                    <div class="text-center">

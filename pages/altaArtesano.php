        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll m-xl-auto" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="loginUsuarioArtesano.php">Login Artesano</a>
                    </li>
                </ul>
                ...
                <div class="row color-texto-blanco">
                    <div class="col-md-7">
                        <div class="header-content-left card-header-pills">
                            <img src="../img/imgPageAltaArtesano/barroNegro.png"
                            style="margin-left:20%; margin-top: 2%;"
                             alt="" width="70%">
                        </div>
                    </div>

                    <div class="col-md-5 mt-3 m-lg-auto">
                        <div class="header-content-right">
                            <form class="well form-horizontal needs-validation"
                                novalidate action="../php/agregarArtesano.php" method="post"
                                id="contact_form" enctype="multipart/form-data">
                                <fieldset>
                                    <br>
                                    <!-- Form Name -->
                                    <h4 class="label_Formulario">Agregar
                                        Artesano</h4>
                                    <br>
                                    <!-- Text input-->
                                    ...
                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Region</label>
                                        <div class="col-md-10 selectContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                        class="glyphicon
                                                        glyphicon-list"></i></span>
                                                <select name="region"
                                                    class="form-control
                                                    selectpicker" required>
                                                    <option value='' disabled
                                                        selected>Selecciona tu
                                                        Region</option>

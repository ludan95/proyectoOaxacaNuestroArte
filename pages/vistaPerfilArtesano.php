    ...
    <div class="row justify-content-md-center ">
      <div class="col col-lg-2 row-cols-6">
        <div class="estilo_borde1 ">
          <div class="div_imagen ">
            ...
            <img width="250px" src="<?php echo $_SESSION['imagenArtesano']; ?>">
          </div>

          <div>
            <h5><?php echo $_SESSION['nombreArtesano']; ?></h5>
          </div>
        </div>
      </div>
      ...
      <div class="col col-lg-5 estilo_completo ">
        ...
        <div class="estilo_borde3 tamanio_alto2 row-cols-6 color-texto-blanco">
          ...
          <br>
          <input style="margin-left: 30px;" type="text" readonly=»readonly» value="<?php echo $_SESSION['nombreArtesano']; ?>" />
          <br>
          <br>

...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll m-xl-auto" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="loginUsuarioCliente.php">Login Cliente</a>
                    </li>
                </ul>
    ...
    <header style="min-height: 800px;" class="tituloCatalogo ">
        <header id="headerUno">
            <div class="container-fluid">
                <div class="row color-texto-blanco">
                    <div class="col-md-7">
                        <div class="header-content-left card-header-pills">
                            <img class="imgAgregarImagenist" style="margin-left:20%; margin-top: 2%;" src="../img/imgPageAltaUsuario/vestidoIstmenio.png" alt="" width="50%">
                        </div>
                    </div>

                    <div class="col-md-5 mt-1 m-lg-auto">
                        <div class="header-content-right">
                            <form class="well form-horizontal needs-validation" action="../php/agregarCliente.php" novalidate method="post" id="contact_form" enctype="multipart/form-data">
                                <fieldset>
                                    <br>
                                    <!-- Form Name -->
                                    <h4 class="label_Formulario">Registrarse</h4>
                                    <br>
                                    <!-- Text input-->
                                    <label class="col-md-4 control-label
                                        label_Formulario">Imagen de Perfil</label>
                                    <br>
                                    <input type="file" name="imagenUsuario" accept=".pdf,.jpg,.png" class="custom-file-input" multiple>

                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Nombre(s)</label>
                                        <div class="col-md-10
                                            inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon
                                                        glyphicon-user"></i></span>
                                                <input name="first_name" placeholder="Nombre(s)" class="form-control" type="name" required="">
                                                <div class="invalid-feedback">Dato
                                                    incorrecto</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Apellido(s)</label>
                                        <div class="col-md-10
                                            inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon
                                                        glyphicon-user"></i></span>
                                                <input name="last_name" placeholder="Apellido(s)" class="form-control" type="last_name" required="">
                                                <div class="invalid-feedback">Dato
                                                    incorrecto</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Correo Electronico</label>
                                        <div class="col-md-10
                                            inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon
                                                        glyphicon-envelope"></i></span>
                                                <input name="email" placeholder="Correo Electronico" class="form-control" type="email" required="">
                                                <div class="invalid-feedback">Dato
                                                    incorrecto</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Contraseña</label>
                                        <div class="col-md-10
                                            inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon
                                                        glyphicon-envelope"></i></span>
                                                <input name="contrasenia" placeholder="Ingresar
                                                    Contraseña" class="form-control" type="password" required="">
                                                <div class="invalid-feedback">Dato
                                                    incorrecto</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <label class="col-md-4 control-label
                                            label_Formulario">Repetir Contraseña</label>
                                        <div class="col-md-10
                                            inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon
                                                        glyphicon-envelope"></i></span>
                                                <input name="repetirContrasenia" placeholder="Repetir
                                                    Contraseña" class="form-control" type="password" required="">
                                                <div class="invalid-feedback">Dato
                                                    incorrecto</div>
                                            </div>

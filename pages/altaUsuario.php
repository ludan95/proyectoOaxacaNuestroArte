                ...
                <div class="row color-texto-blanco">
                    <div class="col-md-7">
                        <div class="header-content-left card-header-pills">
                            <img class="imgAgregarImagenist"
                            style="margin-left:20%; margin-top: 2%;"
                           src="../img/imgPageAltaUsuario/vestidoIstmenio.png"
                                alt="" width="50%">
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 mt-1 m-lg-auto">
                        <div class="header-content-right">
                            <form class="well form-horizontal needs-validation" action="../php/agregarCliente.php" novalidate

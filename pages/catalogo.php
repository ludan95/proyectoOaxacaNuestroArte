...
mysqli_query($conexion, "delete from compratemporal");
        ...
        ?>
          ...
          <div class="col mb-5">
            <div class="card h-100">
              <!-- Product image-->
              <form action="../php/compraTemporal.php" method="POST">
                <div class="row">
                  <!--! ImagenArtesania  -->
                  <div class="row-5">
                    ...
                    <?php if ($row['img_3d'] != 'no') { ?>
                      ...
                      <div style="display:none;">
                        <input type="text" name="id_artesaniaCompra" size="1" value="<?php echo $row['id_artesania'] ?>" readonly="readonly">
                      </div>
                      <?php if ($row['img_3d'] != 'no') { ?>
                        <div class="texto">
                  ...
                  <?php if ($row['img_3d'] != 'no') { ?>
                    <div class="row-6" style="margin: 250px 0 0 10px;">
                    <?php } else { ?>
                      <div class="row-6">
                      <?php } ?>
                      <div class="card-body p-4">
                        <div class="text-center">
                          ...
                          <br>
                          <br>
                          <!-- <label name="id_art" id="id_artid" value="<?php echo $row['id_artesania'] ?>">No. producto: </label> -->
